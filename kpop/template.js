...
const quizQuestions = [
    ...
    { question: "Favorite Animal", answers: [ 
        ...
        {text:"Baby Chick", members:["MEMBER4"]}, 
    ...
    { question: "Favorite English Idiom", answers: [ 
        ...
        {text:"She ate with no crumbs", members:["MEMBER4"]}, 
    ...
    { question: "Another group you like", answers: [ 
        ...
        {text:"Seventeen", members:["MEMBER4"]}, 
    ...
    { question: "Can you handle spicy food?", answers: [ 
        ...
        {text:"Depends on the day", members:["MEMBER4"]} 
    ] },
    { question: "Favorite LE SSERAFIM era", answers: [ 
        {text:"Unforgiven", members:["MEMBER3"]}, 
        {text:"Crazy", members:["MEMBER4"]}, 
        {text:"COMEBACK", members:["MEMBER2","MEMBER1","MEMBER4","MEMBER4","MEMBER3"]}, 
...
function setBias(member) {
    ...
    const subtitle = member === "GROUP" ? "Fearnot" : members[member].subtitle;
...
function showResult() {
    ...
    const subtitle = topMember === "GROUP" ? "Fearnot" : members[topMember].subtitle;
