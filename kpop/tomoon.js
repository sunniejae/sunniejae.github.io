// ===== MEMBER DATA =====
const members = {
    SEOHO: { display: "SEOHO", subtitle: "{MEMBER1Fandom}", color: "var(--SEOHO)", accent: "var(--SEOHO-dark)" },
    ONEUS: { display: "ONEUS", subtitle: "{FANDOM}", color: "var(--primary)", accent: "var(--dark-purple)" },
    LEEDO: { display: "LEEDO", subtitle: "{MEMBER2Fandom}", color: "var(--LEEDO)", accent: "var(--LEEDO-dark)" },
    KEONHEE: { display: "KEONHEE", subtitle: "{MEMBER3Fandom}", color: "var(--KEONHEE)", accent: "var(--KEONHEE-dark)" },
    HWANWOONG: { display: "HWANWOONG", subtitle: "{MEMBER4Fandom}", color: "var(--HWANWOONG)", accent: "var(--HWANWOONG-dark)" },
    XION: { display: "XION", subtitle: "{MEMBER5Fandom}", color: "var(--XION)", accent: "var(--XION-dark)" }
};
...
const products = [
    ...
    { 
        name: "Phone Case", 
        images: { ONEUS: "assets/phonecase-member.png", SEOHO: "assets/blank-SEOHO.png", LEEDO: "assets/blank-LEEDO.png", KEONHEE: "blank-KEONHEE.png", HWANWOONG: "assets/blank-HWANWOONG.png", XION: "assets/blank-XION.png" }, 
        brand: "Sunnie Jae", price: "$25", size:"1pc" 
    },
    { 
        name: "AutoGraphics", 
        images: { ONEUS: "assets/autograph-member.png", SEOHO: "assets/autograph-SEOHO.png", LEEDO: "assets/blank-LEEDO.png", KEONHEE: "assets/blank-KEONHEE.png", HWANWOONG: "assets/blank-HWANWOONG.png", XION: "assets/blank-XION.png" }, 
...
const quizQuestions = [
    ...
    { question: "Favorite English Idiom", answers: [ 
        ...
        {text:"She ate with no crumbs", members:["XION"]}, 
    ...
    { question: "Can you handle spicy food?", answers: [ 
        ...
        {text:"Depends on the day", members:["XION"]} 
    ] },
    { question: "Favorite LE SSERAFIM era", answers: [ 
        {text:"Unforgiven", members:["KEONHEE"]}, 
        {text:"Crazy", members:["XION"]}, 
        {text:"5x", members:["LEEDO","SEOHO","XION","HWANWOONG","KEONHEE"]}, 
...
function setBias(member) {
    ...
    const subtitle = member === "ONEUS" ? "{FANDOM}" : members[member].subtitle;
...
function showResult() {
    ...
    const subtitle = topMember === "ONEUS" ? "{FANDOM}" : members[topMember].subtitle;
