...
const members = {
    ...
    eunchae: { 
        display: "Eunchae", 
        subtitle: "Member of the Eunchae Mother Association", 
        color: "var(--eunchae)", 
...
const quizQuestions = [
    ...
    {
        question: "Down to Earth vs Head in the Clouds",
        answers: [
    ...
    {
        question: "Favorite English Idiom",
        answers: [
...
function selectAnswer(membersArray) {
    // Increment score for each selected answer
...
function showResult() {
    ...
    document.getElementById("result-description").textContent = `You match best with ${members[topMember].display}!`;
