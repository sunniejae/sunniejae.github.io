    ...
    products.forEach(prod => {
        ...
        card.innerHTML = `
            ...
            <div class="product-info">
                ...
                ${
                  prod.brand === "Redbubble"
                    ? `<a class="product-link" href="${prod.link}" target="_blank">Buy on Redbubble</a>`
        ...
        if (prod.brand !== "Redbubble") {
            ...
            btn.addEventListener("click", () => addToWishlist(prod.name));
        }
